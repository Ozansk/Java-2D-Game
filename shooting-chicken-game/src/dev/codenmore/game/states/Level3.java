...
public class Level3 extends State{
	...
	public Level3(Game game) {
		...
		for(int i=8,num=0;i< 16;i++) {
			cats[i] = new Cat(1200-num*32,800,game);
			num++;		
		}
		for(int i=16,num=0;i< 24;i++) {
			cats[i] = new Cat(num*32+800,400,game);
			num++;
		}
		for(int i=24,num=0;i< 40;i++) {
			cats[i] = new Cat(num*32+600,1200,game);
			num++;
		}
		for(int i=40,num=0;i< 48;i++) {
			cats[i] = new Cat(num*32+600,1400,game);
			num++;		
		}
		for(int i=48,num=0;i< 56;i++) {
			cats[i] = new Cat(1200-num*32,1400,game);
			num++;		
		}
		game.setCat(cats);
	}
