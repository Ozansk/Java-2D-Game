...
cats = new Cat[18];
		...
		for(int i=2,num=0;i< 4;i++) {
			cats[i] = new Cat(num*32+600,800,game);
			num++;		
		}
		for(int i=4,num=0;i< 6;i++) {
			cats[i] = new Cat(num*32+950,1000,game);
			num++;		
		}
		for(int i=6,num=0;i< 8;i++) {
			cats[i] = new Cat(num*32+1200,1000,game);
			num++;		
		}
		for(int i=8,num=0;i< 10;i++) {
			cats[i] = new Cat(num*32+700,1000,game);
			num++;		
		}
		for(int i=10,num=0;i< 12;i++) {
			cats[i] = new Cat(num*32+600,1300,game);
			num++;		
		}
		for(int i=12,num=0;i< 14;i++) {
			cats[i] = new Cat(num*32+950,1300,game);
			num++;		
		}
		for(int i=14,num=0;i< 16;i++) {
			cats[i] = new Cat(num*32+1200,1300,game);
			num++;		
		}
		for(int i=16,num=0;i< 18;i++) {
			cats[i] = new Cat(num*32+700,1300,game);
			num++;		
		}
		game.setCat(cats);
	}
